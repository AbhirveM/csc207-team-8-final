 ...
 *
 * <p>Shared by both presenters and by {@code views.LineChart} rather than mirrored on either side
 ...
 *
 * <p>The label is always composed by a presenter. Nothing in {@code views} formats a number, so a
